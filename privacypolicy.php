...
THIS DOCUMENT IS PUBLISHED IN ACCORDANCE WITH THE PROVISIONS OF RULE 3 (1) OF THE INFORMATION TECHNOLOGY (INTERMEDIARIES GUIDELINES) RULES, 2011 THAT REQUIRE PUBLISHING THE RULES AND REGULATIONS, TERMS OF SERVICES, PRIVACY POLICY AND USER AGREEMENT FOR ACCESS OR TERMS OF USAGE OF www.revv.co.in (HEREINAFTER REFERRED TO AS THE “SITE”).
YOUR USE OF THIS SITE, OR YOUR PROVISION TO USE OF ANY PERSONAL INFORMATION CONSTITUTES YOUR AGREEMENT TO THESE TERMS AND ANY SUBSEQUENT CHANGES TO THESE TERMS; DO NOT USE THE SITE OR PROVIDE INFORMATION IF YOU DO NOT AGREE WITH ALL OF THE TERMS.
Privacy Notice
...
As with many websites, we collect certain information. When you browse, read, or download information from the Site, data is collected by the Site, including but not limited to your IP address, URL request, browser type, and date and time of your request. We collect the IP addresses of visitors, time of access, browser type, and web pages visited. We do not collect any other information without your knowledge and permission.
Information You Provide


The Site requests personally identifiable information when you seek a query from the Contact Us Tab on the Site and is subject to the Terms of Use. Such information may be used or requested to perform research, improve usability of the site, administer mailing lists or online communities, or other activities related to the services provided by the Site. This information may include, but is not limited to, person’s names, email addresses, location. The above mentioned data is collected by the Site only with the intention to conduct the business and for the facilitation of the correct and timely delivery of the products and improvement of the services. The collected data is preserved with the Site safely and is not sold/disclosed to a third party, whatsoever, beyond the terms of the privacy policy.
You can request deletion of your account and personal data associated with the account by either writing to us or through the “Manage profile” section on our app.
...
It is however expressly clarified that we will not be responsible for any third party access to information provided by you on the Site by any third party arising as a result of any unauthorized access or use.
Log Files
...
As set forth above under “Normal Browsing” anonymous users may receive session cookies while visiting our Site while their browser is open. “Users” are subject to the Site’s Terms of Use. Registered Users receive session cookies when they are signed into our Site. To facilitate our functions, we may use cookies to recognize when you return to our website, if any.
Posting
...
THE SITE IS NOT ENGAGED IN THE OCCUPATION OF STORING, PROCURING OR USAGE OF THE INFORMATION (USER NAMES, PASSWORDS OR EMAILS) THAT YOU MAY ACCESS BY THE USE OF YOUR SOCIAL NETWORKING ACCOUNT FOR THE PURPOSES OF LIKE, TWEETING, +1 BUTTON, OR MENTIONS AND SUBSEQUENTLY CAN’T BE HELD LIABLE FOR THE SAME.
THIS DOCUMENT IS AN ELECTRONIC RECORD IN TERMS OF INFORMATION TECHNOLOGY ACT, 2000 AND RULES THERE UNDER AS APPLICABLE AND THE AMENDED PROVISIONS PERTAINING TO ELECTRONIC RECORDS IN VARIOUS STATUTES AS AMENDED BY THE INFORMATION TECHNOLOGY ACT, 2000. THIS ELECTRONIC RECORD IS GENERATED BY A COMPUTER SYSTEM AND DOES NOT REQUIRE ANY PHYSICAL OR DIGITAL SIGNATURES.
